...
@section('title', 'Pendataan | Kabupapten Penajam Paser Utara')

@section('content')
<form action="{{route('penajam.store')}}" method="post" enctype="multipart/form-data">

    <form method="POST" action="{{ route('penajam.index') }}">
        @csrf
    <div class="content">       
