...
@section('title', 'Pengajuan | Kabupaten Kutai Kartanegara')

@section('content')
<form action="{{route('kukar.store')}}" method="post" enctype="multipart/form-data">

    <form method="POST" action="{{ route('kukar.index') }}">
        @csrf
    <div class="content">       
