...
@section('title', 'Pengajuan | Kota Samarinda')

@section('content')
<form action="{{route('samarinda.store')}}" method="post" enctype="multipart/form-data">

    <form method="POST" action="{{ route('samarinda.index') }}">
        @csrf
    <div class="content">       
