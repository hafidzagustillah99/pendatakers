...
@section('title', 'Pengajuan | Kota Bontang')

@section('content')
<form action="{{route('bontang.store')}}" method="post" enctype="multipart/form-data">

    <form method="POST" action="{{ route('bontang.index') }}">
        @csrf
    <div class="content">       
