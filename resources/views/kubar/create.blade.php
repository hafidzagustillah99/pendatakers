...
@section('title', 'Pengajuan | Kabupaten Kutai Barat')
    ...
    <form method="POST" action="{{ route('kubar.index') }}">
        ...
        <div class="content">
            <div class="section-body row">
                ...
                <div class="form-group col-sm-6">
                    <label class="form-label"for="mou">No.MOU</label>
                ...
                <div class="form-group col-sm-6">
                    <label class="form-label"for="pks">No. PKS</label>
                ...
                <div class="form-group col-sm-6">
                    <label class="form-label"for="mitrakerja">Mitra Kerja</label>
                ...
                <div class="form-group col-sm-12 mt-3">
                    ...
                    <a href="{{ route('kubar.index') }}" class="btn btn-danger"><i
