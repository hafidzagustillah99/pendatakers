...
@section('title', 'Pengajuan | Kota Balikpapan')

@section('content')
<form action="{{route('balikpapan.store')}}" method="post" enctype="multipart/form-data">

    <form method="POST" action="{{ route('balikpapan.index') }}">
        @csrf
    <div class="content">       
