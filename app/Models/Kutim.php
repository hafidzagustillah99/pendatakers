...
class Kutim extends Model
{
    ...
    {
        return $this->belongsTo(Daerah::class,'daftar_daerah_id')->where('daftar','like','%Kabupaten Kutai Timur%');
    }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            try {
                $daerah = Daerah::where('daftar','like','%Kabupaten Kutai Timur%')->first();
