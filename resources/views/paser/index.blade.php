...
@section('content')
<a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px;float:right" href="{{ route('paser.create') }}"><i class="fa fa-plus"></i>Tambah Data
</a>
...
<table class="table table-bordered table-striped">
        ...
        @foreach($paser as $item)
            ...
            <td><a href="{{ route('paser.edit', [$item->id]) }}" class='btn btn-success'><i class="fa fa-edit"></i>edit</a></td>
