...
@section('title', 'Pengajuan | Kabupaten Mahakam Ulu')

@section('content')
<form action="{{route('mahakam.store')}}" method="post" enctype="multipart/form-data">

    <form method="POST" action="{{ route('mahakam.index') }}">
        @csrf
    <div class="content">       
    ...
    <div class="form-group col-sm-12 mt-3">
        ...
        <a href="{{ route('mahakam.index') }}" class="btn btn-danger"><i class="fa fa-undo"></i>Cancel</a>
        </form>
</form>
    </div>
</div>
